...
namespace SunamoEditorConfig
{
    public class RootBlock
    {
        ...
        public static ResultWithException<RootBlock> Parse(string block, List<string> lines)
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (parts.Count != 2)
                    return new ResultWithException<RootBlock> { Exception = "Unparseable line: \"" + line + "\"" };
            ...
            return new ResultWithException<RootBlock> { Result = rootBlock };
        }
