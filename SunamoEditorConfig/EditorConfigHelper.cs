namespace SunamoEditorConfig
{
    public static class EditorConfigHelper
    {
        ...
        public static ResultWithException<EditorConfigContent> Deserialize(string path, string text)
        {
            ...
            foreach (var block in blocks)
                if (MascBlock.IsLineWithMasc(StringHelper.GetLines(block).First()))
                {
                    ...
                    if (mascBlock.Exception != null)
                        return new ResultWithException<EditorConfigContent> { Exception = mascBlock.Exception };
                ...
                else
                {
                    ...
                    if (rootBlockResult.Exception != null)
                        return new ResultWithException<EditorConfigContent> { Exception = rootBlockResult.Exception };

                    rootBlock = rootBlockResult.Result;
                }

            return new ResultWithException<EditorConfigContent>
