namespace SunamoEditorConfig
{
    public class MascBlock : RootBlock
    {
        ...
        public static ResultWithException<MascBlock> Parse(string block)
        {
            ...
            if (definitions.Exception != null)
                return new ResultWithException<MascBlock> { Exception = definitions.Exception };

            return new ResultWithException<MascBlock>
            {
